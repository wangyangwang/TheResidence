		...
		*/
        ...
        if (target.showWaves){
            ...
            GUI.contentColor = colorEnabled;
				...
				target.waveScale = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+105, setWidth, 18),"",target.waveScale,0.0,2.0);
        ...
        if (target.showSurface){
        	...
        	target.edgeBlend = EditorGUI.Slider(Rect(rt.x+margin+165, rt.y+105, setWidth, 18),"",target.edgeBlend,0.0001,0.2);
        	GUI.contentColor = colorEnabled;
