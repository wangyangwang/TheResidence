...
function LateUpdate () {
	...
	if (!isInBoat){
		...
		if (isWalking){
			...
			fadeSpeed = 0.3;
			playSpeed = 1.1;
			if (moveForward == 1.0 && moveSideways == -1.0){
				useClip = "anim_miho_walk_normal_FL";
				fadeSpeed = 0.6;
				playSpeed = 1.1;
			}
			if (moveForward == 1.0 && moveSideways == 1.0){
				useClip = "anim_miho_walk_normal_FR";
				fadeSpeed = 0.6;
				playSpeed = 1.1;
			}
			if (moveForward == 0.0 && moveSideways == -1.0){
				useClip = "anim_miho_walk_normal_L";
				fadeSpeed = 0.6;
				playSpeed = 1.1;
			}
			if (moveForward == 0.0 && moveSideways == 1.0){
				useClip = "anim_miho_walk_normal_R";
				fadeSpeed = 0.6;
				playSpeed = 1.1;
			}
		}
		...
		if (isRunning){
			...
			playSpeed = 1.0;
			if (moveForward == 1.0 && moveSideways == -1.0){
				useClip = "anim_miho_run_normal_FL";
				fadeSpeed = 0.35;
				playSpeed = 1.0;
			}
			if (moveForward == 1.0 && moveSideways == 1.0){
				useClip = "anim_miho_run_normal_FR";
				fadeSpeed = 0.35;
				playSpeed = 1.0;
			}
			if (moveForward == 0.0 && moveSideways == -1.0){
				useClip = "anim_miho_run_normal_L";
				fadeSpeed = 0.35;
				playSpeed = 1.0;
			}
			if (moveForward == 0.0 && moveSideways == 1.0){
				useClip = "anim_miho_run_normal_R";
				fadeSpeed = 0.35;
				playSpeed = 1.0;
			}
		}
