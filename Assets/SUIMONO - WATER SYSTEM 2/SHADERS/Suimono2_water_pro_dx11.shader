...
void surf (Input IN, inout SurfaceOutput o) {
	...
	//depthColor.a = saturate(_DepthColorB.a-_DepthColorG.a-_DepthColorR.a);
	//depthColor.a += lerp(0.0,saturate(_DepthColorG.a-_DepthColorR.a),depthRamp.g);
	//depthColor.a += lerp(0.0,_DepthColorR.a,depthRamp.r);
